        ...
        <div className="col-md-6">
          <div className="cs-content text-center">
            <span className="cs-topper">
              <ReactTyped
                strings={['¡Hola mundo,', 'Vamos a comenzar a entrenar','Preparado?']}
                typeSpeed={40}
                backSpeed={50}
                loop
              />
            ...
            <p className="cs-text">
              ...
              Gym. Con nuestro equipo de entrenadores expertos, instalaciones de
              vanguardia y una comunidad de apoyo, te ayudaremos a alcanzar tu
              mejor versión.
            </p>
